...
from aiapi.config import RecapAIAPIConfig
...
def configure_loggging():
    log_level = RecapAIAPIConfig.AI_API_LogLevel
...
def configure_app(env, app):
    app.config["AI_API_OPENAI"]=RecapAIAPIConfig.AI_API_OPENAI #OpenAI API Key
    app.config["AI_API_LogLevel"]=RecapAIAPIConfig.AI_API_LogLevel # Set Log Level (DEBUG, INFO, WARNING, ERROR, CRITICAL)
    app.config["SECRET_KEY"]=RecapAIAPIConfig.AI_API_SECRET_KEY # set the key to secure Flask App
